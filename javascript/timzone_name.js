var LocaleTimezone = (function(){
	function LocaleTimezone(){
		...
		if (this.constructor == LocaleTimezone) {
			this.zone = timezone;
			this.time = usertime;
		} else {
			return timezone;
	...
	LocaleTimezone.prototype.toLocaleString = function () {
		return this.time;
	}

	LocaleTimezone.prototype.toString = function() {
		return this.zone;
	};
...
function testTimezone(){
	var zone = new LocaleTimezone();
	console.log("usertime: ", zone.time);
	console.log("timezone: ", zone.zone);
	try{
		if (document && document.write) {
			document.write(zone.time + "<br>");
			document.write(zone.zone + "<br>");
		}
	} catch(e) {
	}
}
